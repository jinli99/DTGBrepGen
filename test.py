...
#
# test_files = ['data_process/GeomDatasets/furniture_parsed/couch/partstudio_0088.pkl']
...
#
#         face_wcs, edge_wcs = joint_optimize(edge_ncs,
#                                             data['face_bbox_wcs'], data['vert_wcs'],
#                                             data['edgeVert_adj'], data['faceEdge_adj'], len(edge_ncs), len(face_ctrs))
#
#         try:
