...
#
#
# datas = ['data_process/GeomDatasets/furniture_parsed/lamp/partstudio_0401.pkl']
# for file in datas:
...
#     data = data.split('/')
#     path = os.path.join('/home/jing/Datasets/furniture_dataset/', data[-2], data[-1].replace('_', '/', 1)[:-4]+'.step')
#     face_type_count = count_face_types(path, face_type_count)
