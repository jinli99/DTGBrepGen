...
python train_gdm.py --data data_process/furniture_parsed \
    --train_list data_process/furniture_data_split_6bit.pkl --option faceBbox --gpu 0 \
    --env furniture_gdm_faceBbox --train_epochs 3000 --test_epochs 50 --save_epochs 500 --batch_size 64 \
