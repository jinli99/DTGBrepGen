...
import argparse
import wandb
from datasets import TopoSeqDataset, FaceEdgeDataset
from trainers import TopoSeqTrainer


def get_args_topo():
    parser = argparse.ArgumentParser()
    parser.add_argument('--batch_size', type=int, default=64, help='input batch size')
    parser.add_argument("--option", type=str, choices=['topoSeq', 'faceEdge'], default='topoSeq')
    ...
    parser.add_argument('--env', type=str, default="furniture_gdm_Topo", help='environment')
